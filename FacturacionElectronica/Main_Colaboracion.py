...
print(f'Main Colaboracion {log_path}')
...
with open(os.path.join(log_path, f'console_log_COLABORACION-{timestamp}.txt'), 'a') as f:
    ...
    exec(open('PlanoColaboracion.py', encoding='utf-8').read())
